...
public class Path implements Iterable<Integer> {        // 包含题目[10]-[14]
    ...
    public /*@ pure @*/ boolean equals(final Object obj) {
        ...
        while (iterator.hasNext() || myIterator.hasNext()) {
            if (/*[12]*/iterator.next().equals(myIterator.next())) {  //TODO
                return false;
            }
        }
        return true;
    ...
    public /*@ pure @*/ boolean isValid() {
        return (size() >= 2 && /*[13]*/ nodes.size() - distinct.size() <= 1);   //TODO  请使用类中的属性(及其方法)和运算符实现
    }
    ...
    public /*@ pure @*/ Path extractLoopPath() {
        ...
        /*[14]*/ loopStartIndex = nodeToIndex.get(nodes.get(index)); //TODO
        loopLastIndex = index;
